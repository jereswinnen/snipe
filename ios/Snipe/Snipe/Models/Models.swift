...
enum Shop: String, Codable, Hashable, Sendable {
    case bol, coolblue, allyourgames, nintendo, dreamland, playstation
...
/// Server-side APNs registration record returned from POST /api/devices.
/// Named `PushDevice` to avoid clashing with the `Device` environment value
/// that describes the current hardware (Environment/Device.swift).
struct PushDevice: nonisolated Codable, Identifiable, Sendable {
    let id: Int
